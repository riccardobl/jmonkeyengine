...
public class TestTransformFeedback extends SimpleApplication{
    ...
    public void simpleInitApp() {
        ...
        transformMesh.setBuffer(new VertexBufferPointer(Type.Position,3,Format.Float,0).ref(buf1));       
    ...
    public void simpleRender(RenderManager rm){
        ...
        VertexBufferPointer positionBuffer=(VertexBufferPointer)transformGeom.getMesh().getBuffer(Type.Position);

        // We use trInput as our position buffer for the transform pass
        positionBuffer.ref(trInput);  // Turn positionBuffer into a pointer to trInput
