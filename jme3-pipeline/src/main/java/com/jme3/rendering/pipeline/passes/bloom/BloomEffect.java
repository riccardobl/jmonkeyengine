...
public class BloomEffect extends Effect {
    ...
    public BloomEffect(Jme3ContextCreator contextFactory,AssetManager assetManager,FrameBufferFactory fbFactory, BloomLayer[] layers) {
        super(fbFactory);
        this.layers=layers;
        ...
        getEffectPipeline().add(merger=new BloomMergePass(contextFactory, fbFactory, assetManager));
        reconnect=true;
    }
